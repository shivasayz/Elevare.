...
import { Camera, Bell, Shield, User, Mail, Briefcase, Globe } from "lucide-react";
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Receive the latest tech news and articles</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Updates about new software releases</p>
                    </div>
                    <Switch />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Summary of your saved items and recommendations</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
